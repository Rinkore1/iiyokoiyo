...
public class FollowDao {
	...
	public void addFollow(User user, long followId, String followName) {
		hbaseDao.updateOneData(Constants.TABLE_FOLLOW, user.getId(), Constants.FAMILY_FOLLOW_NAME, followId,
				followName);
	}
	...
	public void addFollowed(User user, long followedId) {
		hbaseDao.updateOneData(Constants.TABLE_FOLLOWED, followedId + "_" + user.getId(),
				Constants.FAMILY_FOLLOWED_USERID, Constants.COLUMN_FOLLOWED_USERID, user.getId());
	}
