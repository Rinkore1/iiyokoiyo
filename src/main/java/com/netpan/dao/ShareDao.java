...
public class ShareDao {
	...
	public long addShare(User user, Share share) {
		long rowKey = hbaseDao.incrCounter(Constants.TABLE_GID, Constants.ROWKEY_GID_SHAREID,
				Constants.FAMILY_GID_SHAREID, Constants.COLUMN_GID_SHAREID, 1);
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[0], share.getPath());
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[1], share.getOriginalPath());
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[2], share.getType());
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[3], share.getName());
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[4], share.getSharetime());
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[5], share.getShareedUserId());
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[6], share.getShareedUserName());
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[7], rowKey);
		hbaseDao.updateOneData(Constants.TABLE_SHARE, user.getId() + "_" + rowKey, Constants.FAMILY_SHARE_CONTENT,
				Constants.COLUMN_SHARE_DIRTYPEPATHANDETC[8], share.getShareUserName());
		return rowKey;
	}
	...
	public void addShareed(User user, long shareedUserId, long shareid) {
		hbaseDao.updateOneData(Constants.TABLE_SHAREED, shareedUserId + "_" + user.getId() + "_" + shareid,
				Constants.FAMILY_SHAREED_SHAREID, Constants.COLUMN_SHAREED_SHAREID, user.getId() + "_" + shareid);
	}
