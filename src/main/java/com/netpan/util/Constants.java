...
public class Constants {
	...
	public static final String[] COLUMN_FILE_ORIGINALNAMEANDETC = { "originalName", "name", "isFile", "isDir", "length",
			"path", "originalPath", "viewflag", "date" };
	...
	public static final String[] COLUMN_SHARE_DIRTYPEPATHANDETC = { "path", "originalPath", "type", "name", "sharetime",
			"shareedUserId", "shareedUserName", "shareid", "shareUserName" };
